...
<div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
                <a title="Add new guradian info" href="{{ url('admin/guardians/create') }}" target="_blank" class="btn btn-primary m-t-md">
                                    ...
                                    <div class="row">
                                        <div class=" col-md-offset-2 col-md-6">
                                            <div class="fileinput fileinput-new form-group m-t-sm m-b-xs" data-provides="fileinput">
                                                <span class="btn btn-default btn-file"><span class="fileinput-new">select photo</span><span class="fileinput-exists">Change</span><input type="file" name="image" class="form-control input-lg" id="inputFile" value="{{ old('image') }}"></span>
                               ...
                               <div class="row">
                                    <div class="col-lg-2">
                                       <div class="form-group">
                                           ...
                                           <input type="text" id="guardian_phone" class="form-control input-lg" name="guardian_phone" value="{{ old('guardian_phone') }}">
                                       </div>
                                   </div>
                                    <div class="col-lg-4">
                                       <div class="form-group">
                                   ...
                                   <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="date_admitted" class="form-control input-lg" name="date_admitted" value="{{ old('date_admitted') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
