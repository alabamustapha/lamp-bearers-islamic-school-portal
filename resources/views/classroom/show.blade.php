...
<div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2> {{ $classroom->level->name . ' - ' . $classroom->name }}</h2>
            <ol class="breadcrumb">
                <li>
            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        @else
                            @foreach($classroom->students()->where('status', '=', 'active')->get() as $student)
                                <tr class="gradeA">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <tbody>
                        @if($classroom->promoting_and_repeating_students()->count() == 0)
                            {{ "no student promoted or repeated yet" }}
                        @else
                            @foreach($classroom->promoting_and_repeating_students as $student)
                                <tr>
                                    <td>{{ $student->admin_number }}</td>
                                    <td><a href="{{ url('admin/students/' . $student->id) }}" target="_blank" title="{{ 'view ' . $student->name . ' profile' }}">{{ $student->name }}</a></td>
                                    <td>{{ $student->sex }}</td>
                                    <td>{{ $student->dob->format('d/m/Y') }}</td>
                                    <td>{{ $student->house->name }}</td>
