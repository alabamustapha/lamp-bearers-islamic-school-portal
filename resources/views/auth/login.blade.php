    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            {{ csrf_field() }}
                ...
                <a class="btn btn-sm btn-white btn-block" href="{{ url('#') }}">Contact the admin</a>
            </form>
            <p class="m-t">Created by <small> <a href="http://redehub.com.ng">redehubng</a> &copy; {{ '2015 - ' . date('Y') }}</small> </p>
        </div>
    </div>
