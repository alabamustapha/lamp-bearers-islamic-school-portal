...
<div class="wrapper wrapper-content">
   ...
   <div class="row m-t-sm">
        ...
        <div class="row">
            <form class="m-t-md m-b-md text-center close-session" method="POST" action="{{ url('admin/sessions/' . $session->id . "/close" ) }}" onsubmit="return confirm('Are you sure you want to close session?');">
             {{ csrf_field() }}
             {{ method_field('PUT') }}
             <input type="hidden" name="session_id" value="{{ $session->id }}">
