  <div class="row m-b-lg m-t-lg">
                <div class="col-md-5">
                    ...
                    <div class="profile-image">
                        <img src="<?php echo e(has_image($student) ? asset('storage/' . $student->image) : asset('storage/images/' . strtolower($student->sex) . '.png')); ?>" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
