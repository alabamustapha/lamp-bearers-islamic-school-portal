            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $classroom->students()->where('status', '=', 'active')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr class="gradeA">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <tbody>
                        <?php if($classroom->promoting_and_repeating_students()->count() == 0): ?>
                            <?php echo e("no student promoted or repeated yet"); ?>

                        <?php else: ?>
                            <?php $__currentLoopData = $classroom->promoting_and_repeating_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    <td><?php echo e($student->admin_number); ?></td>
                                    <td><a href="<?php echo e(url('admin/students/' . $student->id)); ?>" target="_blank" title="<?php echo e('view ' . $student->name . ' profile'); ?>"><?php echo e($student->name); ?></a></td>
                                    <td><?php echo e($student->sex); ?></td>
                                    <td><?php echo e($student->dob->format('d/m/Y')); ?></td>
                                    <td><?php echo e($student->house->name); ?></td>
                                    <td><?php echo e(isset($student->guardian->name) ? $student->guardian->name : 'N/A'); ?></td>
