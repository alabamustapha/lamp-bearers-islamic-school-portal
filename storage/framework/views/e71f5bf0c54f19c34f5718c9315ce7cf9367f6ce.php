<?php $__env->startSection('title', 'Add guardian'); ?>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form method="POST" class="form" enctype="multipart/form-data" action="<?php echo e(url('admin/guardians')); ?>">
                                         ...
                                         <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-key"></i></span><input type="text" class="form-control input-lg" name="occupation" required="" value="<?php echo e(old('occupation')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                           ...
                           <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-key"></i></span><input type="text" class="form-control input-lg" name="guardian_id" required="" value="<?php echo e(isset($guardian_id) ? $guardian_id : old('guardian_id')); ?>">
                                        </div>
                                    </div>
                                </div>
