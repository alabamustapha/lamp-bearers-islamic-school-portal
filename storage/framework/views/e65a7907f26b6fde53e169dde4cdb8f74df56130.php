                                    ...
                                    <div class="row">
                                        <div class=" col-md-offset-2 col-md-6">
                                            ...
                                            <div class="fileinput fileinput-new form-group m-t-sm m-b-xs" data-provides="fileinput">
                                                <span class="btn btn-default btn-file"><span class="fileinput-new">upload passport</span><span class="fileinput-exists">Change</span><input type="file" name="image" id="inputFile" value="<?php echo e(old('image')); ?>"></span>
