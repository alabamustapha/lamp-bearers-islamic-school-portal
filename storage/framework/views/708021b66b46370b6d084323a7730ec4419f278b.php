...
<div class="wrapper wrapper-content">
   ...
   <div class="row m-t-sm">
                    ...
                    <div class="widget white-bg p-lg text-center">
                        <div class="m-b-md">
                            ...
                            <form class="m-t-md" method="POST" action="<?php echo e(url('admin/sessions/' . $session->id . "/start_first_term" )); ?>">
                             ...
                             <button type="submit" class="btn btn-block btn-info start-term">Start</button>
                             </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="widget white-bg p-lg text-center">
                        ...
                        <form class="m-t-md" method="POST" action="<?php echo e(url('admin/sessions/' . $session->id . "/close_first_term" )); ?>" onsubmit="return confirm('Are you sure you want to close term?');">>
                         ...
                         <input type="hidden" name="session_id" value="<?php echo e($session->id); ?>">
                         <button type="submit" class="btn btn-block btn-info close-term">Close</button>
                         </form>
                    </div>
        ...
        <div class="row">
            <form class="m-t-md m-b-md text-center close-session" method="POST" action="<?php echo e(url('admin/sessions/' . $session->id . "/close" )); ?>" onsubmit="return confirm('Are you sure you want to close session?');">
             <?php echo e(csrf_field()); ?>
...
//                            $('.close-session').submit(function () {
//                                swal({
//                                    title: "Are you sure?",
//                                    text: "You will not be able to restart the session if closed!",
//                                    type: "warning",
...
//                                    closeOnConfirm: true
//                                }, function () {
//                                    swal("Session closed!", "Session closed.", "success");
//                                });
//                            });
...
//                                }, function () {
//                                    swal("Term started!", "New term has commenced", "success");
//                                });
//                            });
