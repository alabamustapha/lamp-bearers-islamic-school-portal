            ...
            <div class="row m-b-lg m-t-lg">
                <div class="col-md-6">
                    ...
                    <div class="profile-image">
                        <img src="<?php echo e(has_image($teacher) ? asset('storage/' . $teacher->image) : asset('storage/images/' . strtolower($teacher->sex) . '.png')); ?>" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
